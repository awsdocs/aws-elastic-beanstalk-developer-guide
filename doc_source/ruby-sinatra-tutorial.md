...
Sinatra requires Ruby 1\.9 or newer\. In this tutorial we use Ruby 2\.5\.1 and the corresponding Elastic Beanstalk platform configuration\. Install Ruby by following the instructions at [Setting Up your Ruby Development Environment](ruby-development-environment.md)\.
