...
When you enable Spot Fleet requests for your environment, this configuration page shows a list of **Instance types** instead of a single setting\. You can select one or more instance types for your Spot Fleet\. For details, see [Spot Fleet Support](using-features.managing.as.md#environments-cfg-autoscaling-spot)\.
