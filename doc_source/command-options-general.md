...
|  **Name**  |  **Description**  |  **Default**  |  **Valid Values**  | 
| --- | --- | --- | --- | 
|  EnableSpot  |  Enable Spot Fleet requests for your environment\. When `false`, some options in this namespace don't take effect\.  |  `false`  |  `true` `false`  | 
