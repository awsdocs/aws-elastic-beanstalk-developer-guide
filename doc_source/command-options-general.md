...
|  MatcherHTTPCode  |  A comma\-separated list of HTTP code\(s\) that indicate that an instance is healthy\.  |  `200`  | With application load balancer: `200` to `499` With network load balancer: `200` to `399`  | 
