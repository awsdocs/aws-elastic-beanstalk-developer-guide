...
+ If you are using Amazon RDS, you must select at least two subnets in different Availability Zones\. To learn how to create subnets for your VPC, see [Task 1: Create the VPC and Subnets](http://docs.aws.amazon.com/vpc/latest/userguide/VPC_Scenario2.html#Case2_Create_VPC_Subnet) in the *Amazon VPC User Guide*\.
