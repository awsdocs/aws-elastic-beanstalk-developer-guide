...
+ If your VPC configuration uses a NAT device, select the security group you created for your instances\. For more information, see [Create a Security Group for Your Instances](vpc-basic.md#create-instance-sg)\. If you do not have a NAT device or if you did not create a security group, you can use the default security group\.
