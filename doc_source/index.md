...
+ [Elastic Beanstalk platforms](concepts-all-platforms.md)
   ...
   + [Deploying Elastic Beanstalk applications from Docker containers](create_deploy_docker.md)
      + [Using the Docker platform](docker.md)
      ...
      + [Using the Multicontainer Docker platform (Amazon Linux AMI)](create_deploy_docker_ecs.md)
   ...
   + [Working with .NET Core on Linux](create-deploy-dotnet-core-linux.md)
      ...
      + [The AWS Toolkit for Visual Studio - Working with .Net Core](dotnet-toolkit-linux.md)
         + [Managing your Elastic Beanstalk application environments](create_deploy_NET-linux.managing.md)
            + [Configuring AWS X-Ray using the AWS toolkit for Visual Studio](create_deploy_NET-linux.managing.x-ray.md)
            + [Configuring EC2 instances using the AWS toolkit for Visual Studio](create_deploy_NET-linux.managing.ec2.md)
            + [Configuring Elastic Load Balancing using the AWS toolkit for Visual Studio](create_deploy_NET-linux.managing.elb.md)
            + [Configuring Auto Scaling using the AWS toolkit for Visual Studio](create_deploy_NET-linux.managing.as.md)
            + [Configuring notifications using AWS toolkit for Visual Studio](create_deploy_NET-linux.container.sns.md)
            + [Configuring additional environment options using AWS toolkit for Visual Studio](create_deploy_NET-linux.advanced-otions.md)
            + [Configuring .NET Core containers using the AWS toolkit for Visual Studio](create_deploy_NET-linux.container.md)
   ...
   + [Deploying Node.js applications to Elastic Beanstalk](create_deploy_nodejs.md)
      ...
      + [Using the Elastic Beanstalk Node.js platform](create_deploy_nodejs.container.md)
         + [Configuring the application process with a Procfile](nodejs-configuration-procfile.md)
...
+ [AWS Elastic Beanstalk security](security.md)
   ...
   + [Identity and access management for Elastic Beanstalk](security-iam.md)
      + [AWS managed policies for AWS Elastic Beanstalk](security-iam-awsmanpol.md)
